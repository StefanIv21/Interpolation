function A = bicubic_coef(f, Ix, Iy, Ixy, x1, y1, x2, y2)
    ...
    Prima_Matrice=[1 0 0 0; 0 0 1 0; -3 3 -2 -1; 2 -2 1 1];
    
    Ultima_Matrice=[1 0 -3 2; 0 0 3 -2; 0 1 -2 1; 0 0 -1 1];
    
    Mijloc=[f(y1,x1),f(y2,x1),Iy(y1,x1),Iy(y2,x1);
    ...
    Mijloc=double(Mijloc);
    % TODO: Calculeaz? matricea final?.
    A=Prima_Matrice*Mijloc*Ultima_Matrice;
endfunction